...
Figure 1 shows the mean streamflow in August 2025 (as example) compared to the mean streamflow in all years from 1980–2025 and mean streamflow in other months compared to all other months in all years. In August 2025, around 921 gauges out of 1566 gauges have the mean streamflow classified as  “below normal” category (Figures 1 & 2). Streamflow classification is adapted from the [USGS WaterWatch](https://waterwatch.usgs.gov/index.php?id=ww_current).

<p align="center">
  <img src="inst/FlowStats/data/monthly_report/Mean_Q_August_2025.png" width=100% title="This is a screenshot from FlowStats">
</p>
Figure 1. Mean streamflow in August 2025 is compared to the mean streamflow in August across the years 1980–2025.
...
Figure 2. Monthly mean streamflow compared to the mean streamflow of the corresponding months across the years 1980–2025. For example, the last column in this figure represents the mean streamflow in August 2025 compared to the mean streamflow in August of other years (1980–2025), as shown in Figure 1.
